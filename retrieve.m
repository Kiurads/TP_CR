function [retrieved_indexes, similarities, new_case] = retrieve(case_library, new_case, similarity_threshold)
    ...
    for i=1:size(case_library,1)
        ...
        final_similarity = calculate_harvesine_distance(cur_case_latlon, new_case_latlon);
...
function [holiday_type_sim] = get_holiday_type_similarities()
    ...
    holiday_type_sim.similarities = [
        ...
        1.0 0.7 0.5 0.1 0.1 0.8 0.9 0.8                                         % Active
        0.9 1.0 0.6 0.2 0.1 0.6 0.1 0.1                                         % Bathing
        0.5 0.2 1.0 0.6 0.8 0.8 0.0 0.7                                         % City
        0.3 0.1 0.6 1.0 0.2 0.4 0.2 0.1                                         % Education
        0.0 0.1 0.6 0.9 1.0 0.6 0.3 0.1                                         % Language
        0.8 0.9 0.6 0.4 0.4 1.0 0.9 0.7                                         % Recreation
        0.8 0.1 0.1 0.3 0.0 0.8 1.0 0.2                                         % Skiing
        0.7 0.1 0.6 0.1 0.2 0.6 0.3 1.0                                         % Wandering
    ];
end
...
function [accommodation_sim] = get_accommodation_similarities()
    ...
    accommodation_sim.similarities = [
        ...
        1.0 0.8 0.6 0.1 0.4 0.2                                                    % FiveStars
        0.8 1.0 0.8 0.2 0.6 0.4                                                    % FourStars
        0.6 0.8 1.0 0.4 0.8 0.6                                                    % HolidayFlat
        0.1 0.2 0.4 1.0 0.6 0.8                                                    % OneStar
        0.4 0.6 0.8 0.6 1.0 0.8                                                    % ThreeStars
        0.2 0.4 0.6 0.8 0.8 1.0                                                    % TwoStars
    ];
end
...
function [res] = calculate_euclidean_distance(val1, val2)
    diff = val1 - val2;
    res = sqrt(sum(diff.^2))/length(diff); 
end
